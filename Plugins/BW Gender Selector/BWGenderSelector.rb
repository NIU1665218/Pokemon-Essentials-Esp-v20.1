...
#===================================================
  ...
  @sprites["boy"].zoom_x = 1.75; @sprites["boy"].zoom_y = 1.75
...
if !pbConfirmMessage(_INTL("Eres un chico? (Recuerda que no hay opcion de ser un helicoptero de combate)"))
22.times do
Graphics.update
@sprites["gendergirl"].x -= 16
@sprites["girl"].x -= 12
...
@sprites["msgwindow"].visible = true
  ...
  pbMessage("Podrias decirme tu nombre?")
  selectName
end
...
if !pbConfirmMessage(_INTL("Eres una chica? (Recuerda que no hay opcion de ser un helicoptero de combate)"))
22.times do
Graphics.update
@sprites["genderboy"].x += 16
@sprites["boy"].x += 12
...
def pbUpdate
  ...
  pbMessageDisplay(@sprites["msgwindow"],
      _INTL("Bueno, al lio, empecemos la aventura. Eres un chico o una chica?"))
  selectBoy
loop do
  Graphics.update
  Input.update
